...
for i in range(30):
    ...
    fig, ax = plt.subplots(figsize=(4, 2))  # width, height in inches
    ax.plot(load_data)
...
if initial_design and updated_design:
    fig2, ax2 = plt.subplots(figsize=(4, 2))  # width, height in inches
...
if initial_design and updated_design:
    ...
    fig3, ax3 = plt.subplots(figsize=(4, 2))  # width, height in inches
...
if updated_design:
    ...
    fig4, ax4 = plt.subplots(figsize=(4, 2))  # width, height in inches
